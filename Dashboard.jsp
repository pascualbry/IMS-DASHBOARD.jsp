...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><a>031720<%=obj_Variable_Order.getTag() %></a></td>
		...
		<td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCG.jsp">Pending</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCG.jsp">Ongoing</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
		<td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCG.jsp">QC Passed</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/DELIVERY/Delivery.jsp">For Delivery</a></td>      
