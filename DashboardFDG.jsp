...
<div class="navbar">
  <div class="heading">
    <a href="/IMS/DASHBOARD/DashboardFDG.jsp">ORDER<br/>TRACKING<br/>SYSTEM</a>
  </div>
  <ul>
    <li class="active">
      <a>
    ...
    <li class="unactive">
      <a href="/IMS/PURCHASING/PurchasingFDG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <div class="dropdown">
        ...
        <div id="myDropdown" class="dropdown-content">
          <a href="/IMS/INVENTORY/BrandFDG.jsp">Brand</a>
          <a href="/IMS/INVENTORY/CategoryFDG.jsp">Category</a>
          <a href="/IMS/INVENTORY/ProductFDG.jsp">Product</a>
        </div>
      </div>
    </li>

    <li class="unactive">
      <a href="/IMS/QUALITYCONTROL/QCGFDG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <a href="/IMS/DELIVERY/DeliveryFDG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <a href="/IMS/REPORTS/ReportsFDG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <div class="dropdown">
        ...
        <div id="myDropdown" class="dropdown-content">
          <a href="/IMS/ACCOUNT/AccountsFDG.jsp"><i class="fa fa-user" aria-hidden="true" font-size="14"></i>&nbsp;&nbsp;&nbsp;&nbsp;Account</a>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white">Delivered</a></td>   
