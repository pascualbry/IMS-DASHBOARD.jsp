...
<div class="navbar">
  <div class="heading">
    <a href="/IMS/DASHBOARD/DashboardQCG.jsp">ORDER<br/>TRACKING<br/>SYSTEM</a>
  </div>
  <ul>
    <li class="active">
      <a>
    ...
    <li class="unactive">
      <a href="/IMS/PURCHASING/PurchasingQCG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <div class="dropdown">
        ...
        <div id="myDropdown" class="dropdown-content">
          <a href="/IMS/INVENTORY/BrandQCG.jsp">Brand</a>
          <a href="/IMS/INVENTORY/CategoryQCG.jsp">Category</a>
          <a href="/IMS/INVENTORY/ProductQCG.jsp">Product</a>
        </div>
      </div>
    </li>

    <li class="unactive">
      <a href="/IMS/QUALITYCONTROL/QCGQCG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <a href="/IMS/DELIVERY/DeliveryQCG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <a href="/IMS/REPORTS/ReportsQCG.jsp">
      <div class="icon">
    ...
    <li class="unactive">
      <div class="dropdown">
        ...
        <div id="myDropdown" class="dropdown-content">
          <a href="/IMS/ACCOUNT/AccountsQCG.jsp"><i class="fa fa-user" aria-hidden="true" font-size="14"></i>&nbsp;&nbsp;&nbsp;&nbsp;Account</a>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCGQCG.jsp">Pending</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCGQCG.jsp">Ongoing</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
		<td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/QUALITYCONTROL/QCGQCG.jsp">QC Passed</a></td>
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/DELIVERY/DeliveryQCG.jsp">For Delivery</a></td>      
...
%>		
	...
	<tr>
		...
		<td style="width: 12.67%"><%=obj_Variable_Order.getContactNumber() %></td>
		<td style="width: 12.67%"><%=obj_Variable_Order.getLocation() %></td>
        <td style="width: 12.67%"><a style="text-decoration: none; color: white" href="/IMS/REPORTS/ReportsQCG.jsp">Delivered</a></td>   
